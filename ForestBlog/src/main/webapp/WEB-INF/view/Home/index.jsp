                ...
                <ul style="margin-top: 0px;">
                    <c:forEach items="${noticeList}" var="n">
                        <li class="scrolltext-title">
                            <a href="/ForestBlog/notice/${n.noticeId}" rel="bookmark">${n.noticeTitle}</a>
                        </li>
                    </c:forEach>
                </ul>
            </div>
            ...
            <c:forEach items="${pageInfo.list}" var="a">
                ...
                <article class="post type-post">
                    ...
                    <figure class="thumbnail">
                        <a href="/ForestBlog/article/${a.articleId}">
                            <img width="280" height="210"
                                 src="/ForestBlog/img/thumbnail/random/img_${a.articleId%15}.jpg"
                                 class="/ForestBlogattachment-content size-content wp-post-image"
                                 alt="${a.articleTitle}">
                        </a>
                        <span class="cat">
                                <a href="/ForestBlog/category/${a.categoryList[fn:length(a.categoryList)-1].categoryId}">
                    ...
                    <div class="entry-content">
                        ...
                        <span class="entry-meta">
                            ...
                            <span class="comment">&nbsp;&nbsp;
                                <a href="/ForestBlog/article/${a.articleId}#comments" rel="external nofollow">
