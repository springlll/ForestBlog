...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        <div class="layui-logo"><a href="/ForestBlog/admin" style="color:#009688;">
        ${options.optionSiteTitle}后台
        </a>
        </div>
        <!-- 头部区域（可配合layui已有的水平导航） -->
        <ul class="layui-nav layui-layout-left">
            <li class="layui-nav-item"><a href="/ForestBlog/" target="_blank">前台</a></li>
            <li class="layui-nav-item">
                <a href="javascript:;">新建</a>
                <dl class="layui-nav-child">
                    <dd><a href="/ForestBlog/admin/article/insert">文章</a></dd>
                    <dd><a href="/ForestBlog/admin/page/insert">页面</a></dd>
                    <dd><a href="/ForestBlog/admin/category/insert">分类</a></dd>
                    <dd><a href="/ForestBlog/admin/notice/insert">公告</a></dd>
                    <dd><a href="/ForestBlog/admin/link/insert">链接</a></dd>
                </dl>
            </li>
        </ul>
        <ul class="layui-nav layui-layout-right">
            <li class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    <dd><a href="/ForestBlog/admin/user/profile">基本资料</a></dd>
                </dl>
            </li>
            <li class="layui-nav-item">
                <a href="/ForestBlog/admin/logout">退了</a>
            </li>
        </ul>
    </div>
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="/ForestBlog/admin/article">全部文章</a></dd>
                        <dd><a href="/ForestBlog/admin/article/insert">写文章</a></dd>
                        <dd><a href="/ForestBlog/admin/category">全部分类</a></dd>
                        <dd><a href="/ForestBlog/admin/tag">全部标签</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
