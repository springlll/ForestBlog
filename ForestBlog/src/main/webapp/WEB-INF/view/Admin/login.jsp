...
<head>
    ...
    <link rel="shortcut icon" href="/ForestBlog/img/logo.png">
    ...
    <style type="text/css">
        body{
            ...
            background: url(/ForestBlog/img/loginBg.jpg);
            width:100%;
            height:100%;
        }
        .login h1 a {
...
<div id="login">
    <h1><a href="/ForestBlog/" title="欢迎您光临本站！" tabindex="-1">${options.optionSiteTitle}</a></h1>
    <%
         String username = "";
         String password = "";
         //获取当前站点的所有Cookie
    ...
    <p id="backtoblog"><a href="/ForestBlog/">&larr; 返回到风吟博客</a></p>
