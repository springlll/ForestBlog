...
//            articleList.get(i).setTagList(tagList);
    ...
    public Article getArticleByStatusAndId(Integer status, Integer id) {
        ...
        if (article != null) {
        	Integer intsId = article.getArticleId();
        	System.out.println(intsId);
        	List<String> categoryList = articleCategoryRefMapper.listCategoryByArticleId(intsId);
        	System.out.println(categoryList);
//            List<Category> categoryList = articleCategoryRefMapper.listCategoryByArticleId(intsId);
